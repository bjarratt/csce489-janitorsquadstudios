    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 position = setPosition(screenManager.GraphicsDevice.PresentationParameters.BackBufferWidth -
                                           14*screenManager.GraphicsDevice.PresentationParameters.BackBufferWidth/15,
                                            screenManager.GraphicsDevice.PresentationParameters.BackBufferHeight -
                                            4*screenManager.GraphicsDevice.PresentationParameters.BackBufferHeight/5);
            ...
            Vector2 titlePosition = setPosition(screenManager.GraphicsDevice.PresentationParameters.BackBufferWidth -
                                                screenManager.GraphicsDevice.PresentationParameters.BackBufferWidth/4,
                                                 screenManager.GraphicsDevice.PresentationParameters.BackBufferHeight -
                                                 screenManager.GraphicsDevice.PresentationParameters.BackBufferHeight/4);
